...
test('package and skill identifiers are ccc-loop and shipped text has no stale identifier', () => {
...
test('installer defaults to ccc-loop and --name overrides the install directory', () => {
...
test('installer warns about a superseded install without deleting it and is silent otherwise', () => {
  ...
  try {
    ...
    assert.match(output(present), /superseded by ccc-loop/);
